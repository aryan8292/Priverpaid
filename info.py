...
PICS = (environ.get('PICS', 'https://graph.org/file/ca3bb83d7676cb29a3163.jpg')).split() #SAMPLE PIC
NOR_IMG = environ.get("NOR_IMG", "https://graph.org/file/ca3bb83d7676cb29a3163.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://t.me/ary_botz")
SPELL_IMG = environ.get("SPELL_IMG", "https://graph.org/file/ca3bb83d7676cb29a3163.jpg")
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002210069498') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002210069498)
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001756081670')
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://graph.org/file/63f78472ec9d5757b9a14.jpg')
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/ary_backup')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/ary_backup')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/ary_botz')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'ary_backup') # Support Chat Link Without https:// or @
